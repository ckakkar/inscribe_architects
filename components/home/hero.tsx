      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <div className="relative h-[1.5px] bg-grey-mouse/40 mx-auto my-8 sm:my-12 md:my-14 arch-line" />
            <h2 className="font-display font-light text-2xl sm:text-3xl md:text-4xl lg:text-5xl tracking-[0.1em] text-grey-mouse mt-8 sm:mt-12 md:mt-14">
              ARCHITECTS
            </h2>
          </motion.div>
          ...
          >
            ...
            <p className="text-sm sm:text-base text-grey-mouse/80 font-light leading-relaxed max-w-xl mx-auto px-4 sm:px-0">
          ...
          >
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 sm:gap-12 md:gap-16">
              <div className="text-center">
                ...
                <p className="text-xs font-light text-grey-mouse/70 uppercase tracking-wider">Years</p>
              </div>
              <div className="w-px h-8 bg-grey-mouse/10 hidden sm:block" />
              <div className="text-center">
                <p className="text-2xl sm:text-3xl md:text-4xl font-light text-black mb-2">1100+</p>
                <p className="text-xs font-light text-grey-mouse/70 uppercase tracking-wider">Projects</p>
              </div>
            </div>
          </motion.div>
