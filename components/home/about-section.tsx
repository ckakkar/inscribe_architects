    ...
    <section className="py-16 sm:py-24 md:py-32 relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-light mb-8 sm:mb-10 md:mb-12 leading-tight text-black px-4 sm:px-0">
            Founded by{' '}
          ...
          <p className="text-sm sm:text-base text-grey-mouse/80 font-light leading-relaxed px-4 sm:px-0">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="text-center py-6 sm:py-8 md:py-12 border-b border-grey-mouse/20 relative"
            >
              <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light text-black mb-2 sm:mb-3">
                <AnimatedCounter value={stat.number} duration={2} />
              </h3>
              <p className="text-grey-mouse/80 text-xs font-light uppercase tracking-wider">
                {stat.label}
              </p>
            </motion.div>
          ))}
